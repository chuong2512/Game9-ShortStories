...
public class IAPKey
{
    public const string PACK1 = "pack_books_1";
    public const string PACK2 = "pack_books_2";
    public const string PACK3 = "pack_books_3";
    public const string PACK4 = "pack_books_4";
    public const string PACK5 = "pack_books_5";
    public const string PACK6 = "pack_books_6";

    public const string PACK1_REGISTER = "pack_register_books_1";
    public const string PACK2_REGISTER = "pack_register_books_2";
    public const string PACK3_REGISTER = "pack_register_books_3";
    public const string PACK4_REGISTER = "pack_register_books_4";
    public const string PACK5_REGISTER = "pack_register_books_5";
}
